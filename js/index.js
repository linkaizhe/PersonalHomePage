$(document).ready(function() {
	...
	$('.main_nav--next').on('click', function() {
		var carouselId = $(this).attr('data-nav');
    ...
    $('.player_btn').on('click', function() {
        $(this).toggleClass('player_btn--active');
	...
	<div class="plyr__controls">
		...
		<div class="plyr__wrap">
			<button type="button" class="plyr__control" aria-label="Mute" data-plyr="mute">
				...
				<span class="label--pressed plyr__tooltip" role="tooltip">取消静音</span>
				<span class="label--not-pressed plyr__tooltip" role="tooltip">静音</span>
			</button>
			...
			<a href="https://www.baidu.com/" class="plyr__control" aria-label="Playlist">
				...
				<span class="plyr__tooltip" role="tooltip">播放列表</span>
			</a>
		</div>
	</div>
	`;
